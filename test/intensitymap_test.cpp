...
class TestIntensityMap : public QObject
{
    Q_OBJECT;
private slots:
    void constructed();
...
void TestIntensityMap::constructed()
{
...
void TestIntensityMap::constructedImage()
{
...
void TestIntensityMap::constructedPixmap()
{
    QImage image(2, 2, QImage::Format_RGB32);
    image.fill(QColor(255, 100, 0, 255));
...
QTEST_MAIN(TestIntensityMap)
#include "intensitymap_test.moc"